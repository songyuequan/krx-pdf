...
public class MuPDFActivity extends RoboActivity implements FilePicker.FilePickerSupport {
  ...
  public void createUI(Bundle savedInstanceState) {
    ...
    mPageSlider.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
      public void onStopTrackingTouch(SeekBar seekBar) {
        mDocView
            .setDisplayedViewIndex((seekBar.getProgress() + mPageSliderRes / 2) / mPageSliderRes);
      }
    ...
    mSearchText.addTextChangedListener(new TextWatcher() {
      ...
      public void afterTextChanged(Editable s) {
        ...
        if (SearchTaskResult.get() != null && !mSearchText.getText().toString()
  ...
  private void reflowModeSet(boolean reflow) {
    ...
    mReflowButton
        .setColorFilter(mReflow ? Color.argb(0xFF, 172, 114, 37) : Color.argb(0xFF, 255, 255, 255));
  ...
  private void setButtonEnabled(ImageButton button, boolean enabled) {
    ...
    button
        .setColorFilter(enabled ? Color.argb(255, 255, 255, 255) : Color.argb(255, 128, 128, 128));
  }
